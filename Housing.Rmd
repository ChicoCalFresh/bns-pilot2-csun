...
There are `r unname(table(bns$q24)['No'])` people that participated in the survey that do not currently live in the city/area of their enrolled college. There are also `r unname(table(bns$q24)['Yes'])` people that say they do live in the city/area of their enrolled college.
...
Over the past 12 months, the majority of people were never unsure of where they would be sleeping (`r unname(table(bns$q34)['Never'])` people) or have not moved houses (`r unname(table(bns$q35)['None'])` people). Responses claiming sleep location uncertainty were closely distributed among the frequency options. There were `r unname(table(bns$q35)['Once'])` people that claimed they moved once in the last 12 months and `r unname(table(bns$q35)['Twice'])` people have moved twice. Only a small minority have moved 3 or more times in the last 12 months.
...
- Students with at least 1 homelessness insecurity indicator present are considered to have experienced homelessness at the date of survey `r print_n_reporting("homelessness_year")`
