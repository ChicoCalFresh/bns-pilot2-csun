...
The average number of academic hours worked per week (denoted by the dotted line) is `r round(mean(tmp$units, na.rm = TRUE), 2)`, while the median is `r median(tmp$units, na.rm = TRUE)` hours. The majority of students working 36 or more hours per week, with `r names(sort(table(tmp$units), decreasing=TRUE)[1])` hours being most common (`r unname(sort(table(tmp$units), decreasing=TRUE)[1])` people) and `r names(sort(table(tmp$units), decreasing=TRUE)[2])` hours the second most frequent (`r unname(sort(table(tmp$units), decreasing=TRUE)[2])` people). 
...
The average number of total hours worked per week (denoted by the dotted line) is `r round(mean(tmp$TotalHours, na.rm = TRUE), 2)`, while the median is `r median(tmp$TotalHours, na.rm = TRUE)` hours. The data indicates that the majority of students are working over full-time in total. The most common response was `r names(sort(table(tmp$TotalHours), decreasing=TRUE)[1])` hours worked per week (`r unname(sort(table(tmp$TotalHours), decreasing=TRUE)[1])` people) and `r names(sort(table(tmp$TotalHours), decreasing=TRUE)[2])` hours worked per week the second most frequent (`r unname(sort(table(tmp$TotalHours), decreasing=TRUE)[2])` people).
