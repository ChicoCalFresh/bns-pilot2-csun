...
Over the past year, `r unname(sort(table(bns$q91), decreasing = TRUE)['No'])` students did not receive or try to receive mental health services. `r unname(sort(table(bns$q91), decreasing = TRUE)['Yes'])` people claim that they have received or tried to receive mental health services.
</div>
</div>
