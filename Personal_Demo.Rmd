...
Of the survey participants, `r unname(table(bns$q7)['Woman'])` of them identify as a woman and `r unname(table(bns$q7)['Man'])` identify as a man. There are also 4 survey participants who preferred not to answer this question.
