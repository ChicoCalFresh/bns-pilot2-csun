...
plot_frq(bns$sugar_drinks_ounces_daily, ylim=c(0,75))+ xlab('Daily Sugar/Energy Drink Servings (Ounces)')
```
...
p1 <- plot_frq(bns$alc_consumption_weekly, title="How often do you consume alcohol:") +xlab('Days Consumed')
p2 <- plot_frq(bns$alc_servings_if_consumed, ylim=c(0,12), title="If consumed, how many servings:") + xlab('Number of Alcohol Servings')
...
The data indicates the weekly alcohol consumption, the majority of people claim to consume alcohol `r names(sort(table(bns$alc_consumption_weekly), decreasing = TRUE))[1]` days per week (`r unname(sort(table(bns$alc_consumption_weekly), decreasing = TRUE))[1]` people). While `r unname(sort(table(bns$alc_consumption_weekly), decreasing = TRUE))[2]` people claim to drink `r names(sort(table(bns$alc_consumption_weekly), decreasing = TRUE))[2]` days per week. Only a small number of people claim to drink 3 or more days per week. Of the people who do consume alcohol, `r unname(sort(table(bns$alc_servings_if_consumed), decreasing = TRUE))[1]` people consume `r names(sort(table(bns$alc_servings_if_consumed), decreasing = TRUE))[1]` servings. `r unname(sort(table(bns$alc_servings_if_consumed), decreasing = TRUE))[2]` people claim to drink `r names(sort(table(bns$alc_servings_if_consumed), decreasing = TRUE))[2]` servings,  `r unname(sort(table(bns$alc_servings_if_consumed), decreasing = TRUE))[3]` people claim to drink `r names(sort(table(bns$alc_servings_if_consumed), decreasing = TRUE))[3]` serving, and only a small number drink 5 or more servings.
