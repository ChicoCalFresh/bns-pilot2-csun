...
# Load data
load("C:/Users/rdonatello/Box/CHC All/01. Projects Active/CFO (SP6495202)/08. Research and Evaluation/02. Data Analysis/BNS3-pilot2/data/BNSp2_clean.Rdata")
#bns <- BNSp2b

# Filter to only CSUN
bns <- filter(BNSp2b, school == "CSU, Northridge")
